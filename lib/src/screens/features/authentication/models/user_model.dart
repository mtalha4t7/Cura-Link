...
class UserModel {
  ...
  /// Constructor
  const UserModel(
      {this.id, required this.email, this.password, required this.fullName, required this.phoneNo,required this.userType});
  ...
  static UserModel empty () => const UserModel(id: '', email: '', fullName: '', phoneNo: '', userType: '');
