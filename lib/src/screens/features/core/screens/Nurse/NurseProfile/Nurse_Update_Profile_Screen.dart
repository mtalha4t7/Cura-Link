...
class NurseProfileFormScreen extends StatefulWidget {
  ...
  @override
  _NurseProfileFormScreenState createState() =>
      _NurseProfileFormScreenState();
}

class _NurseProfileFormScreenState
    extends State<NurseProfileFormScreen> {
  ...
  Future<void> _getName() async {
    try {
      final userNameResponse = await controller.getNurseUserName(email!);
  ...
  Future<void> _getPhone() async {
    try {
      final userPhoneResponse = await controller.getNursePhone(email!);
